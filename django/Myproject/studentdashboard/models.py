...
class StudentProfile(models.Model):
    ...
    def __str__(self): # dunder method: defines string representation
        return self.name

class StudentGrade(models.Model):
    student = models.ForeignKey(StudentProfile, on_delete=models.CASCADE, related_name='grades')#detete casecade means jaba student profile delete huncha taba yo pani delete huncha

    # Choices for Semester
    SEM_CHOICES = [   # list of tuples
        ('1st', '1st Semester'),
        ('2nd', '2nd Semester'),
        ('3rd', '3rd Semester'),
        ('4th', '4th Semester'),
    ...
    def save(self, *args, **kwargs):
        ...
        if self.gpa >= 2.0:
            ...
            self.status = "Fail"
        super().save(*args, **kwargs)# super call gareko ho save method lai override garna ko lagixa
